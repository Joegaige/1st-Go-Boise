...
namespace GoMap
{
	...
	public class GOMap : MonoBehaviour 
	{
		...
		[Regex (@"^(?!\s*$).+", "Please insert your MapBox Access Token")]public string mapbox_accessToken = "pk.eyJ1IjoiZ3JlYXN5Z3VpbmVhIiwiYSI6ImNrMXdhdmgyNDAwNDgzbG80bGZvcXBnM2IifQ.XkpSBVRU23ET7R-fYYypQg";
		[Regex (@"^(?!\s*$).+", "Please insert your OSM API key")]public string osm_api_key = "";
		[Regex (@"^(?!\s*$).+", "Please insert your Nextzen API key")] public string nextzen_api_key = "3V3G3joyRxaqbQBDp4MdbA";
		...
		void Start () 
	    {
			...
			if ( mapType == GOMapType.Nextzen && (nextzen_api_key == null || nextzen_api_key == "3V3G3joyRxaqbQBDp4MdbA")) {
				Debug.LogError ("[GOMap] Nextzen api key is missing, GET iT HERE: https://developers.nextzen.org/keys");
				return;
			}

			else if (mapType == GOMapType.Mapbox  && (mapbox_accessToken == null || mapbox_accessToken == "pk.eyJ1IjoiZ3JlYXN5Z3VpbmVhIiwiYSI6ImNrMXdhdmgyNDAwNDgzbG80bGZvcXBnM2IifQ.XkpSBVRU23ET7R-fYYypQg")) {
